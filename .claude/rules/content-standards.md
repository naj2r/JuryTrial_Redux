...
### Project-Specific Table Requirements

<!-- ADD YOUR PROJECT-SPECIFIC TABLE REQUIREMENTS HERE.
     Example (from a real project):

     For this project, every regression table must include:
     - **Exposure variable units** in the table note
     - **Clustering level** stated
     - **Sample description**: which sample variant
     - **Fixed effects row**: County FE (Yes/No), Year FE (Yes/No)
     - **Mean of dependent variable** for each specification

     See domain-profile.md for your project's conventions. -->
