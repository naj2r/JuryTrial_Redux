...
## Project-Specific Methods Concerns

<!-- ADD YOUR PROJECT-SPECIFIC METHODS CHECKS HERE.
     When you customize this agent for your project, add checks for the
     specific econometric threats your referees will raise.

     Example categories (from a real project):

     ### Baseline Window Contamination (CRITICAL)
     - Treatment timing + baseline window validation

     ### Sample Selection on Treatment Intensity (MAJOR)
     - Full vs restricted sample as primary specification

     ### Limited Pre-Period Problem (MAJOR)
     - HonestDiD/Rambachan-Roth bounds for limited pre-periods
     - Anticipation vs pre-trend failure interpretation

     ### Concentration & Leverage (MAJOR)
     - Top-unit dominance concerns (jackknife)

     ### Alternative Estimator Positioning (MINOR)
     - PPML / count model diagnostics and framing

     See domain-profile.md for your project's identification strategy. -->
