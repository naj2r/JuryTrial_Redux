...
## Project-Specific Domain Concerns

<!-- ADD YOUR PROJECT-SPECIFIC DOMAIN CHECKS HERE.
     When you customize this agent for your project, add checks targeting
     your field's concerns about your specific paper.

     Example categories (from a real project):

     ### Institutional Mechanism Validity
     - Does the paper establish the institutional mechanism behind the proxy variable?
     - Legal/regulatory citations for the measurement approach

     ### Policy Shock Credibility
     - Are policy shocks well-described with institutional detail?
     - Do the shocks satisfy exogeneity requirements?

     ### External Validity
     - Single-state/region generalizability acknowledged?
     - Within-study variation documented?

     ### Literature Positioning
     - Key citations for your field and subfield
     - Missing related work to check for

     See domain-profile.md for your project's field conventions. -->
