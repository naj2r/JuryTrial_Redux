...
cell B pressure_pop actually_reported  %9.1f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell B pressure_pop told_to_report     %9.1f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
cell B pressure_pop pct_told_to_report %9.3f
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
cell B pressure_pop sent_to_courtroom  %9.1f
local pb4 "`r(coef)'"
local ps4 "`r(se)'"
cell B pressure_pop pct_sent_to_courtroom %9.3f
local pb5 "`r(coef)'"
local ps5 "`r(se)'"
cell B pressure_pop questioned_in_voir_dire %9.1f
local pb6 "`r(coef)'"
local ps6 "`r(se)'"
cell B pressure_pop pct_questioned_in_voir_dire %9.3f
local pb7 "`r(coef)'"
local ps7 "`r(se)'"
cell B pressure_pop utilization_rate   %9.3f
local pb8 "`r(coef)'"
local ps8 "`r(se)'"
...
file write t "         & `s1' & `s2' & `s3' & `s4' & `s5' & `s6' & `s7' & `s8' \\[0.5em]" _n
...
file write t `"\multicolumn{9}{l}{\footnotesize Panel A: \textit{pressure} = incumbent faces election. Panels B--C: coefficient on \textit{contested} (uncontested controlled).}\\"' _n
...
* Controlled spec (+ log population)
cell A pressure_pop actually_reported  %9.1f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell A pressure_pop told_to_report     %9.1f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
cell A pressure_pop pct_told_to_report %9.3f
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
...
file write t "         & `s1' & `s2' & `s3' \\[0.5em]" _n
...
* Controlled spec (+ log population)
cell B pressure_pop actually_reported_p10k    %9.2f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell B pressure_pop total_jury_verdicts_p10k  %9.2f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
...
local b2e "`r(coef)'"
local s2e "`r(se)'"
cell B pressure_pop pct_other_felony %9.3f
local b3e "`r(coef)'"
local s3e "`r(se)'"
...
cell B_highpop pressure_pop actually_reported %9.1f
local b1c "`r(coef)'"
local s1c "`r(se)'"
cell B_highpop pressure_pop told_to_report %9.1f
local b2c "`r(coef)'"
local s2c "`r(se)'"
cell B_highpop pressure_pop pct_told_to_report %9.3f
local b3c "`r(coef)'"
local s3c "`r(se)'"
cell B_highpop pressure_pop utilization_rate %9.3f
local b4c "`r(coef)'"
local s4c "`r(se)'"
cell B_highpop pressure_pop total_jury_verdicts %9.1f
local b5c "`r(coef)'"
local s5c "`r(se)'"
cell B_highpop pressure_pop capital_felony %9.1f
local b6c "`r(coef)'"
local s6c "`r(se)'"

* Panel D: Below-median with log(population) control
cell B_lowpop pressure_pop actually_reported %9.1f
local b1d "`r(coef)'"
local s1d "`r(se)'"
cell B_lowpop pressure_pop told_to_report %9.1f
local b2d "`r(coef)'"
local s2d "`r(se)'"
cell B_lowpop pressure_pop pct_told_to_report %9.3f
local b3d "`r(coef)'"
local s3d "`r(se)'"
cell B_lowpop pressure_pop utilization_rate %9.3f
local b4d "`r(coef)'"
local s4d "`r(se)'"
cell B_lowpop pressure_pop total_jury_verdicts %9.1f
local b5d "`r(coef)'"
local s5d "`r(se)'"
cell B_lowpop pressure_pop capital_felony %9.1f
local b6d "`r(coef)'"
local s6d "`r(se)'"
...
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
cell B pressure_pop total_jury_verdicts %9.1f
local pb4 "`r(coef)'"
local ps4 "`r(se)'"
cell A pressure_pop capital_felony     %9.1f
local pb5 "`r(coef)'"
local ps5 "`r(se)'"
cell B pressure_pop pct_other_felony   %9.3f
local pb6 "`r(coef)'"
...
file write t "         & `s1' & `s2' & `s3' & `s4' & `s5' & `s6' \\[0.5em]" _n
...
* Panel C: Above-median with log(population) control
cell B_highpop pressure_pop pct_capital_felony %9.3f
local b1c "`r(coef)'"
local s1c "`r(se)'"
cell B_highpop pressure_pop pct_other_felony %9.3f
local b2c "`r(coef)'"
local s2c "`r(se)'"
cell B_highpop pressure_pop pct_other_cases %9.3f
local b3c "`r(coef)'"
local s3c "`r(se)'"

* Panel D: Below-median with log(population) control
cell B_lowpop pressure_pop pct_capital_felony %9.3f
local b1d "`r(coef)'"
local s1d "`r(se)'"
cell B_lowpop pressure_pop pct_other_felony %9.3f
local b2d "`r(coef)'"
local s2d "`r(se)'"
cell B_lowpop pressure_pop pct_other_cases %9.3f
local b3d "`r(coef)'"
local s3d "`r(se)'"
...
local ap1 "`r(coef)'"
local aps1 "`r(se)'"
cell B pressure_pop capital_felony %9.1f
local ap2 "`r(coef)'"
local aps2 "`r(se)'"
cell B pressure_pop other_felony %9.1f
local ap3 "`r(coef)'"
local aps3 "`r(se)'"
cell B pressure_pop other_cases %9.1f
local ap4 "`r(coef)'"
local aps4 "`r(se)'"
cell B pressure_pop pct_capital_felony %9.3f
local ap5 "`r(coef)'"
local aps5 "`r(se)'"
cell B pressure_pop pct_other_felony %9.3f
local ap6 "`r(coef)'"
local aps6 "`r(se)'"
cell B pressure_pop pct_other_cases %9.3f
local ap7 "`r(coef)'"
local aps7 "`r(se)'"
...
file write t "            & `as1' & `as2' & `as3' & `as4' & `as5' & `as6' & `as7' \\[0.5em]" _n
...
* Controlled spec (+ log population)
cell D pressure_pop actually_reported  %9.1f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell D pressure_pop told_to_report     %9.1f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
cell D pressure_pop pct_told_to_report %9.3f
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
...
* Controlled spec
cell D pressure_pop total_jury_verdicts %9.1f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell D pressure_pop pct_capital_felony %9.3f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
cell D pressure_pop pct_other_felony   %9.3f
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
...
* Controlled spec
cell E pressure_pop actually_reported  %9.1f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell E pressure_pop told_to_report     %9.1f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
cell E pressure_pop pct_told_to_report %9.3f
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
...
* Controlled spec
cell E pressure_pop total_jury_verdicts %9.1f
local pb1 "`r(coef)'"
local ps1 "`r(se)'"
cell E pressure_pop pct_capital_felony %9.3f
local pb2 "`r(coef)'"
local ps2 "`r(se)'"
cell E pressure_pop pct_other_felony   %9.3f
local pb3 "`r(coef)'"
local ps3 "`r(se)'"
